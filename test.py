...
with open('medicines.txt', 'r', encoding='utf8', errors='ignore') as fin:
    raw1 = fin.read().lower()

with open('Questions.txt', 'r', encoding='utf8', errors='ignore') as fin:
    raw = fin.read().lower()
...
def response_med(user_response):
    robo_response = ''
        ...
        if (user_response == 'thanks' or user_response == 'thank you'):
            ...
            if (greeting(user_response) != None):
                ...
                if response(user_response) != "I am sorry! I don't understand you":
                    user_response_med=input()
                    user_response_med=user_response_med.lower()
                    if greeting(user_response_med)!=None:
                        print("ROBO: " + greeting(user_response))
                    else:
                        print("ROBO: ", end="")
                        print(response_med(user_response_med))
                        sent_tokens1.remove(user_response_med)
